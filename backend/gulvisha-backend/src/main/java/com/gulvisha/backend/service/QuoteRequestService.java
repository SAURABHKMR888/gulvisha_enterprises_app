...
public class QuoteRequestService {
    ...
    public QuoteRequestResponse submit(QuoteRequest request) {
        UUID organizationId = getDefaultOrganizationId();
    ...
    public Page<AdminQuoteRequestResponse> findAll(Pageable pageable) {
        return quoteRequestRepository.findAllByOrganizationIdOrderByReceivedAtDesc(getDefaultOrganizationId(), pageable)
                .map(this::toAdminResponse);
    }

    public Page<AdminQuoteRequestResponse> findAll(Pageable pageable, String status) {
        String normalizedStatus = normalizeStatus(status);
        return quoteRequestRepository.findAllByOrganizationIdAndStatusOrderByReceivedAtDesc(getDefaultOrganizationId(), normalizedStatus, pageable)
                .map(this::toAdminResponse);
    }
    ...
    public Page<AdminQuoteRequestResponse> search(Pageable pageable, String status, String search) {
        ...
        return quoteRequestRepository.search(getDefaultOrganizationId(), normalizedStatus, search.trim(), pageable)
                .map(this::toAdminResponse);
    }
    ...
    public Page<AdminQuoteRequestResponse> filter(Pageable pageable, String status, String search,
        ...
        return quoteRequestRepository.filter(getDefaultOrganizationId(), normalizedStatus, normalizedSearch, fromDate, toDate, pageable)
                .map(this::toAdminResponse);
    }
